  ...
  inline void process_command() {
    switch (JTAG2::packet.body[0]) {
      ...
      case JTAG2::CMND_GO:
        ...
        JTAG2::go();
        break;
      case JTAG2::CMND_SET_DEVICE_DESC:
        /* This descriptor is selected if RSP_SIGN_ON's S_MCU_FW_MAJ is 0x06. */
      ...
      if (SYS::checkTimeouts() & WAIT_FOR_TARGET) {
        ...
        JTAG2::set_status(JTAG2::RSP_NO_TARGET_POWER, 0); //this error looks like the best fit
      }
    #endif
  }
}
